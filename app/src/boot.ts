...
export class BootSequence {
  ...
  private letters: SVGTextElement | null;
  ...
  constructor(private stage: HTMLElement) {
    ...
    // Logo text removed; the typed-letter pipeline tolerates its absence.
    ...
    new BootLettering(this.brandLines[0], ["brand"]).setText("DNT TERMINAL");
    ...
    this.companyInk.forEach((el) =>
      new BootLettering(el.querySelector("span")!, ["company"]).setText("DNT_OF"),
    );
  }
